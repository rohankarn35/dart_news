...
class entairtnment extends StatefulWidget {
  const entairtnment({super.key});

  @override
  State<entairtnment> createState() => _entairtnmentState();
}

class _entairtnmentState extends State<entairtnment>
  ...
  getnews() async {
    ...
    int i = 0;
    String url =
        "https://newsapi.org/v2/everything?q=movies&from=$cdate&sortBy=publishedAt&apiKey=0a7e9229bfdc4858857e13edb6350189";
